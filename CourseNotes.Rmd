...
You then have to put the data somewhere useful for the package to load your data. For example, you may create a folder for all the files for this class, e.g., "QuantII". 
